...
@TeleOp(name = "Yesterday", group = "Iterative Opmode")
//@Disabled
public class driveYest extends OpMode {
    double posRelic;
...
*/
        ...
        if (a == 1) {
            ...
            if (gamepad2.x || gamepad2.y) {
                ...
                // DOOR GOING UP
                if (!flagSideOpen && flagDoorMovingUp && gamepad2.x && magnet.getState()) {
            ...
            if (gamepad1.a && !touchUp.getState()) {
                servosGlyph[0].setPosition(0);
                servosGlyph[1].setPosition(1);
            }
...
//            }
            ...
            if (gamepad2.right_stick_button) {//auto relic
                if (relicEncoder < 1500) {//open relic dc
                    relicDC.setTargetPosition(relicEncoder + 350);
                    relicDC.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                    relicDC.setPower(1);
                }
                if (1500 < relicEncoder && relicEncoder < 2400) {
